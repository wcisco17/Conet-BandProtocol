...
var BaseClient = /** @class */ (function () {
    ...
    BaseClient.prototype.createTransaction = function (to, data, isFeelessable, nonce) {
        return __awaiter(this, void 0, void 0, function () {
            var sender;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        sender = _a.sent();
                        return [2 /*return*/, new Transaction(this.web3, sender, to, data, isFeelessable, nonce)];
                }
            });
        });
    };
